		...
		<div id="shortcut">
			<ul>
				...
				<li>
					<a href="/partymgr/control/viewprofile?partyId=${(userLogin.partyId)!}" class="jarvismetro-tile big-cubes selected bg-color-pinkDark"> <span class="iconbox"> <i class="fa fa-user fa-4x"></i> <span>个人信息 </span> </span> </a>
				</li>
			</ul>
		</div>
