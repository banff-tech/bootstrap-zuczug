...
//			}
			...
			dispatcher.runSync("createProductStoreGroup", UtilMisc.toMap("userLogin", userLogin,
					"productStoreGroupId", productStoreId, "primaryParentGroupId","RETAIL","productStoreGroupName",storeName
					));
