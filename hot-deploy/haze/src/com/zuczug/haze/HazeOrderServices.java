...
import org.ofbiz.order.order.OrderLookupServices;
...
/**
 * @author Sven Wong
 * @version 创建时间：2016年3月22日 下午4:30:22
 * @description：
 */

public class HazeOrderServices {
	public static final String module = HazeOrderServices.class.getName();
	
	/**
	 * 重写findOrders service，并且增加一个通过facilityId查询的
	 * @author sven
	 * @param dctx
	 * @param context
	 * @return
	...
	public static Map<String, Object> findOrders(DispatchContext dctx, Map<String, ? extends Object> context) {
        ...
        if(UtilValidate.isNotEmpty(facilityId)){
        	paramList.add("originFacilityId=" + facilityId);
        	conditions.add(makeExpr("originFacilityId", facilityId));
        }
        ...
        OrderLookupServices.filterInventoryProblems(context, result, orderList, paramList);
