...
<div id="partyContactInfo" class="screenlet">
    <div class="screenlet-title-bar">
        <#if security.hasEntityPermission("PARTYMGR", "_CREATE", session) || userLogin.partyId == partyId>
            ...
            <a class="btn btn-primary " href="<@ofbizUrl>editcontactmech?partyId=${partyId}</@ofbizUrl>"> ${uiLabelMap.CommonCreateNew}
            </a>
        </#if>
        <br class="clear" />
    </div>
    <div class="screenlet-body">
         ...
         <table class="basic-table" cellspacing="0" style="width: 100%;margin-top: 14px;">
             <tr>
             ...
             <tr>
                 ...
                 <td class="button-col">
                   <#if security.hasEntityPermission("PARTYMGR", "_UPDATE", session) || userLogin.partyId == partyId>
                       <a href="<@ofbizUrl>editcontactmech?partyId=${partyId}&amp;contactMechId=${contactMech.contactMechId}</@ofbizUrl>" class="btn btn-primary">${uiLabelMap.CommonUpdate}</a>
                   </#if>
                   <#if security.hasEntityPermission("PARTYMGR", "_DELETE", session) || userLogin.partyId == partyId>
                       ...
                       <form name="deleteContactForm_${contactMechMap_index}" method="post" action="<@ofbizUrl>deleteContactMech</@ofbizUrl>" onsubmit="javascript:submitFormDisableSubmits(this)">
