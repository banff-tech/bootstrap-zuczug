...
<div id="findOrders" class="screenlet">
    <div class="screenlet-title-bar">
        <ul>
            ...
            <li><a href="<@ofbizUrl>EditShipment</@ofbizUrl>">新建送货</a></li>-->
        </ul>
        <br class="clear"/>
    </div>
    <div class="screenlet-body">
        <form method="post" name="lookupShipmentForm" action="<@ofbizUrl>FindShipment</@ofbizUrl>">
            ...
            <table cellspacing="0" cellpadding="2" class="basic-table">
              ...
              <tr>
                <td width="25%" align="right" class="label">送货状态</td>
                <td width="5%">&nbsp;</td>
                <td>
                  <select name="statusId">
                  	<option value=""></option>
                    <option value="SHIPMENT_INPUT">已输入</option>
                    <option value="SHIPMENT_SCHEDULED">已计划</option>
                    <option value="SHIPMENT_DELIVERED">已投递</option>
                    <option value="SHIPMENT_CANCELLED">已取消</option>
                  </select>
                </td>
              </tr>
              <tr>
                <td width="25%" align="right" class="label">预计送货日期</td>
                <td width="5%">&nbsp;</td>
                <td>
...
<div id="findOrders_2" class="screenlet">
    <div class="screenlet-title-bar">
        <ul>
            <li class="h3">送货列表${shipmentList?size}</li>
        ...
        <#if shipmentList?has_content>
          ...
          <#list shipmentList as shipment>
            ...
            <tr valign="middle"<#if alt_row> class="alternate-row"</#if>>
              <td><a href="<@ofbizUrl>EditShipment?shipmentId=${shipment.shipmentId}</@ofbizUrl>" class="buttontext">${shipment.shipmentId}</a></td>
              ...
              <!--<td align="right"><a href="<@ofbizUrl>ViewShipment?shipmentId=${shipment.shipmentId}</@ofbizUrl>" class="buttontext">${uiLabelMap.CommonView}</a></td>-->
            </tr>
