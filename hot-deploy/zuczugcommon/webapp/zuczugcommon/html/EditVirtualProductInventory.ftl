    ...
    <div class="screenlet-body">
        <table cellspacing="0" class="basic-table">
            ...
            <#list variantInventorySummaries as variantSummary>
             <#assign goodIdentification = delegator.findOne('GoodIdentification',Static["org.ofbiz.base.util.UtilMisc"].toMap("goodIdentificationTypeId", "ZUCZUG_CODE", "productId", variantSummary.productId),true)>
            <tr valign="middle"<#if rowClass == "1"> class="alternate-row"</#if>>
                <td><!--<a href="<@ofbizUrl>EditProductInventoryItems?productId=${variantSummary.productId}&idValue=${goodIdentification.idValue}</@ofbizUrl>" class="buttontext">-->${goodIdentification.idValue}<!--</a>--></td>
                    <#list featureTypeIds as featureTypeId>
